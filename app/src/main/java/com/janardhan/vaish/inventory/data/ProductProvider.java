...
public class ProductProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.janardhan.vaish.inventory/products"
        // will map to the integer code {@link #PRODUCT}S. This URI is used to provide access
        ...
        // The content URI of the form "content://com.janardhan.vaish.inventory/products/#" will
        ...
        // For example, "content://com.janardhan.vaish.inventory/products/3" matches, but
        // "content://com.janardhan.vaish.inventory/products" (without a number at the end)
        // doesn't match.
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection,
        ...
        switch (match) {
            ...
            case PRODUCT_ID:
                ...
                // For an example URI such as "content://com.janardhan.vaish.inventory/products/3",
    ...
    /**
     * Insert a product into the database with the given content values. Return the new content
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        Long supplierNumber = values.getAsLong(ProductEntry.COLUMN_SUPPLIER_NUMBER);
        if (supplierNumber == null || supplierNumber <= 0) {
            throw new IllegalArgumentException("Product requires a valid supplier number");
